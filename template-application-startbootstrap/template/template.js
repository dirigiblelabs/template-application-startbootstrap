...
var uiAngularjsTemplateManager = require("template-application-ui-startbootstrap/template/template");
...
exports.getTemplate = function (parameters) {
    ...
    return {
        name: "Application - full stack based on Start Bootstrap (AngularJS)",
        description: "Application - full stack based on Start Bootstrap with a Database Schema, a set of REST Services and an AngularJS User Interfaces",
        extension: "model",
